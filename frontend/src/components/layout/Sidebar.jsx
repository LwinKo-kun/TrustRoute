...
export default function Sidebar({ activePage = '' }) {
  const navItems = [
    ...
    { name: 'Marketplace', path: '/marketplace', icon: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4' },
  ...
  return (
    <aside className="hidden lg:block w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 sticky top-16 h-screen">
      <div className="p-6">
        <Link to="/dashboard" className="flex items-center gap-2 mb-8">
          <div className="w-8 h-8 bg-indigo-600 rounded-lg flex items-center justify-center">
            <span className="text-white font-bold">TR</span>
          </div>
          <span className="font-bold text-gray-900 dark:text-white">TrustRoute</span>
        </Link>
